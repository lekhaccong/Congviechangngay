...
export const BACKUP_MODULES: { key: ModuleKey; label: string }[] = [
  ...
  { key: "shifts", label: "Ca" },
  { key: "workSchedules", label: "Lịch ca theo ngày" },
  { key: "scheduleAdjustments", label: "Điều chỉnh ca" },
  ...
  { key: "amhs", label: "AMH" },
  { key: "monthlyPayroll", label: "Bảng công và quyết toán tháng" },
...
const TABLE_FILE: Record<ModuleKey, string> = {
  ...
  groups: "groups.json",
  shifts: "shifts.json",
  workSchedules: "workSchedules.json",
  scheduleAdjustments: "scheduleAdjustments.json",
  ...
  overtimes: "ot.json",
  amhs: "amh.json",
  monthlyPayroll: "monthlyPayroll.json",
  dataItems: "data.json",
